...
namespace AulasECursos.Infrastructure.Data.Migrations.Sqlite
{
    ...
    [Migration("20260719183451_InitialSqlite")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AulasECursos.Domain.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AulasECursos.Domain.Entities.Enrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AulasECursos.Domain.Entities.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AulasECursos.Domain.Entities.Enrollment", b =>
                {
                    b.HasOne("AulasECursos.Domain.Entities.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AulasECursos.Domain.Entities.Student", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("AulasECursos.Domain.Entities.Student", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("AulasECursos.Domain.Entities.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
